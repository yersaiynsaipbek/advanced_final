...
func (h *AuthHandlers) RegisterForm(context *gin.Context) {
...
func (h *AuthHandlers) LoginForm(context *gin.Context) {
	context.HTML(http.StatusOK, "login.html", nil)
}

func (h *AuthHandlers) Login(context *gin.Context) {
	var data forms.LoginForm
	data.Username = context.PostForm("username")
	data.Password = context.PostForm("password")
	...
	context.Redirect(http.StatusFound, "/courses/")
}
